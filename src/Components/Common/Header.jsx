        ...
        <ToastContainer/>
            <header class="bg-[#0f172a] text-white px-6 py-4">
                <div class="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    {/* <!-- Center Navigation --> */}
                    <nav class="hidden md:flex gap-8 text-gray-300 text-sm">
                        ...
                        <Link to="/pages" className="hover:text-white transition">Daily Horoscope</Link>
                        <Link to="/gallery" className="hover:text-white transition">Tarot Reading</Link>
